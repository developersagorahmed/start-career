    ...
    return (
       ...
       <div>
        ...
        <div className='md:w-[1050px] ' >
            <h3 className='md:leading-[85px] font-extrabold text-[30px] md:text-[75px] text-[#1A1919]'>One Step Closer To Your <br /><span className='font-extrabold text-transparent text-[80px] bg-clip-text bg-gradient-to-r from-[#7E90FE] to-[#9873FF]'>Dream Job</span></h3>
       ...
       <div className='md:pb-7 md:flex md:mt-8 md:gap-10'>
        {
       ...
       <h1 className='text-5xl  text-center font-extrabold text-[#1a1919]'>Featured Jobs</h1>
        ...
        <div className='md:grid md:grid-cols-2 md:gap-8 md:mx-[30px]'>
